...
public class CustomerChangePassword extends JFrame implements ActionListener

{
	...
	public CustomerChangePassword(String userId)
	{
	    super("Library Management System - Change Password(For Customer)");
